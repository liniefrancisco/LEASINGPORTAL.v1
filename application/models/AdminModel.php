...
=======
    ...
    # NEW PAYMENT MODEL FUNCTIONS

    public function getPaymentsLedger($tenant_id, $startDate, $endDate, $table){
        $result = $this->db->SELECT('*')
                            ->FROM($table)
                            ->WHERE("document_type IN ('Payment', 'Payment Adjustment')")
                            ->WHERE("upload_status <> 'Uploaded'")
                            ->WHERE("posting_date BETWEEN '" . $startDate . "' AND '" . $endDate . "'")
                            ->WHERE('tenant_id', $tenant_id)
                            ->GET()
    ...
    public function getPaymentsTable($tenant_id, $startDate, $endDate, $table){
        $result = $this->db->SELECT('*')
                            ->FROM($table)
                            ->WHERE("upload_status <> 'Uploaded'")
                            ->WHERE("posting_date BETWEEN '" . $startDate . "' AND '" . $endDate . "'")
    ...
    public function getPaymentsScheme($tenant_id, $startDate, $endDate, $table){
        $result = $this->db->SELECT('*')
                            ->FROM($table)
                            ->WHERE("upload_status <> 'Uploaded'")
                            ->WHERE('tenant_id', $tenant_id)
    ...
    public function getPaymentsLedgerCAS($tenant_id, $startDate, $endDate, $table){
        $result = $this->cas->SELECT('*')
                            ->FROM($table)
                            ->WHERE("document_type IN ('Payment', 'Payment Adjustment')")
                            ->WHERE("upload_status <> 'Uploaded'")
    ...
    public function getPaymentsTableCAS($tenant_id, $startDate, $endDate, $table){
        $result = $this->cas->SELECT('*')
                            ->FROM($table)
                            ->WHERE("upload_status <> 'Uploaded'")
                            ->WHERE("posting_date BETWEEN '" . $startDate . "' AND '" . $endDate . "'")
    ...
    public function getPaymentsSchemeCAS($tenant_id, $startDate, $endDate, $table){
        $result = $this->cas->SELECT('*')
                            ->FROM($table)
                            ->WHERE("upload_status <> 'Uploaded'")
                            ->WHERE('tenant_id', $tenant_id)
