                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">
                                ...
                                <strong>Upload Payment Data Per Store</strong>
                            </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Upload Payment Data Per Store</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <button type="submit" class="btn btn-block btn-primary rounded-0" ng-click="getpaymentperstore()"><i class="fas fa-cogs"></i> Generate Payment Data</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                <form method="post" id="soauploadtableform" ng-show="paymentupload" ng-cloak ng-submit="uploadpaymentselected($event)">
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group row">
                                            ...
                                            <table id="paymentuploadtable" class="table table-sm table-bordered table-hover">
                                                ...
                                                <tbody style="font-size: 12px;">
                                                    <tr ng-repeat="p in payment">
                                                        ...
                                                        <td class="text-center">{{ p.trade_name }}</td>
                                                        <td class="text-center">{{ p.tenant_id }}</td>
                                                        <td class="text-center">{{ p.receipt_no }}</td>
                                                        <td class="text-center">{{ p.soa_no }}</td>
                                                        <td class="text-center">{{ p.tender_typeDesc }}</td>
                                                        <td class="text-right">{{ p.amount_due | currency: ''}}</td>
...
<div class="content-wrapper" ng-controller="adminpayment" ng-cloak>
                ...
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-9 col-lg-9">
                                            <select class="form-control rounded-0" name="tenanttype"
                                                ng-model="tenanttype" required>
                                    ...
                                    <div class="form-group row">
                                        <label for="store" class="col-sm-3 col-form-label"><span
                                                class="important">*</span> Store</label>
                                        <div class="col-sm-12 col-md-9 col-lg-9">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="input-group mb-3">
                                        <label for="datefrom" class="col-sm-3 col-form-label"><span
                                                class="important">*</span>Date From</label>
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                        </div>
                                        <input type="date" id="datefrom" name="datefrom" class="form-control rounded-0"
                                            ng-model="datefrom" required>
                                    </div>
                                    <div class="input-group mb-3">
                                        <label for="dateto" class="col-sm-3 col-form-label"><span
                                                class="important">*</span>Date To</label>
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                        </div>
                                        <input type="date" id="dateto" name="dateto" class="form-control rounded-0"
                                            ng-model="dateto" required>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label"></label>
                                        <div class="col-sm-9">
                                            <button type="submit" class="btn btn-block btn-primary rounded-6"
                                                ng-click="getpaymentperstore()"><i class="fas fa-cogs"></i> Generate
                                                Payment Data</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form method="post" id="soauploadtableform" ng-show="paymentupload" ng-cloak
                                ng-submit="uploadpaymentselected($event)">
                                <hr>
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group row">
                                            <label for="forwardedbalance" class="col-form-label"></label>
                                            <div class="col-sm-5">
                                                <button type="submit" class="btn btn-info btn-sm rounded-6"
                                                    title="Upload Selected" name="uploadselect"
                                                    ng-disabled="uploadselect"><i class="fas fa-upload"></i> Upload
                                                    Selected</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row" ng-if="paymentuploadtable">
                                    <div class="col-12">
                                        <table id="paymentuploadtable"
                                            class="table table-sm table-bordered table-hover">
                                            <thead class="color">
                                                <tr>
                                                    <th class="text-center"
                                                        style="position: '' !important; width: 50px;">
                                                        <input class="checkbox" ng-checked="uploadall()" type="checkbox"
                                                            class="ml-5 mr-5" ng-model="headerCheck" id="headerCheck"
                                                            name="headerCheck">
                                                    </th>
                                                    <th class="text-center">Payee</th>
                                                    <th class="text-center">Tenant ID</th>
                                            ...
                                            <tbody style="font-size: 12px;">
                                                <tr ng-repeat="p in payment">
                                                    <td class="text-center">
                                                        <input class="checkbox" type="checkbox" id="paymentcheck"
                                                            name="paymentcheck[]" value="{{p.id}}"
                                                            ng-model="p.paymentcheck">
                                                    </td>
                                                    <td class="text-center">{{ p.trade_name }}</td>
                                                    <td class="text-center">{{ p.tenant_id }}</td>
                                                    <td class="text-center">{{ p.receipt_no }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            <button
                                                                class="btn btn-info dropdown-toggle btn-sm rounded-6"
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right rounded-0"
                                                                ...
                                                                <a href="#" class="dropdown-item"
                                                                    ng-click="viewpayment(p)"><i
                                                                        class="fas fa-search"></i> View</a>
                                                                <a href="#" class="dropdown-item"
                                                                    ng-click="uploadpayment(p)"><i
    ...
    <!-- Modal -->
    <div class="modal fade" id="paymentdetailsmodal" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="paymentdetailsmodal" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-header color rounded-0">
                    <h5 class="modal-title" id="paymentdetailsmodal"><i class="fa fa-info-circle"></i> Payment Details
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body">
                    <div class="col-sm-12 col-lg-12">
                        <div class="form-group row">
                            <label for="tenantid" class="col-sm-3 col-form-label">Invoice No.</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control rounded-0" id="tenantid" name="tenantid"
                                    ng-model="invoiceno" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tenantid" class="col-sm-3 col-form-label">Posting Date</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="tenantid" class="col-sm-6 col-form-label">Grand Total</label>
                                <div class="col-sm-3 col-md-3 col-lg-12">
                                    <input type="text" class="form-control rounded-0 text-right currency"
                                        placeholder="&#8369 0.00" id="tenantid" name="tenantid"
                                        value="&#8369 {{ grand_total | currency : '' }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
