...
<div class="content-wrapper" ng-controller="uploadhistory" ng-cloak>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-3 col-form-label"></label>
                                        <div class="col-sm-9">
                                            <button type="button" class="btn btn-block btn-primary rounded-6"
                                                ng-click="gethistory()"><i class="fas fa-cogs"></i> Generate
                                                History</button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table id="uploadhistorytable" class="table table-sm table-bordered table-hover">
                                        ...
                                        <tbody style="font-size: 12px;">
                                            <tr ng-repeat="h in history">
                                                ...
                                                <td class="text-center">{{ h.username }}</td>
                                                <td class="text-center">
                                                    <button class="btn btn-info btn-xs rounded-6" title="View History"
    ...
    <!-- Modal -->
    <div class="modal fade" id="historymodal" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="paymentdetailsmodal" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content rounded-0">
                <div class="modal-header color rounded-0">
                    <h5 class="modal-title" id="paymentdetailsmodal"><i class="fa fa-info-circle"></i> Upload History
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control rounded-0" id="tenantid" name="tenantid"
                                        ng-model="tenantid" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="typeUploaded" class="col-sm-3 col-form-label">Type Uploaded</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control rounded-0" id="typeUploaded"
                                        name="typeUploaded" ng-model="typeUploaded" readonly>
                                </div>
...
=======
                                <div class="col-sm-6">
                                    <input type="text" class="form-control rounded-0" id="dateUploaded"
                                        name="dateUploaded" ng-model="dateUploaded" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="statusMessage" class="col-sm-3 col-form-label">Status Message</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control rounded-0" id="statusMessage"
                                        name="statusMessage" ng-model="statusMessage" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
