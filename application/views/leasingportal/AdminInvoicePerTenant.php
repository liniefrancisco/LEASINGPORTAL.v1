        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body">
                            <form ng-submit="uploadpertenant($event)" name="uploadpertenantform" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            <label for="tenant_from" class="col-sm-3 col-form-label"><span
                                                    class="important">*</span> Tenant From</label>
                                            <div class="col-sm-12 col-md-9 col-lg-9">
                                                <select class="form-control rounded-0" name="tenant_from"
                                                    ng-model="tenant_from" required>
                                                    <option value="" disabled="" selected="" style="display:none">Please
                                                        Select One</option>
                                                    <option value="Internal">Internal</option>
                                                    <option value="CAS">CAS</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 col-md-9 col-lg-9">
                                                <input type="text" class="form-control" id="trade_name"
                                                    name="trade_name" ng-model="trade_name"
                                                    ng-keyup="searchTenant($event)" placeholder="Search Name"
                                                    autocomplete="off" required>
                                                <input type="hidden" class="form-control" id="id" ng-model="id">
                                                <div class="search-results" ng-repeat="t in tenants"
                                                    ng-if="hasResults == 1">
                                                    <a href="#" ng-repeat="t in tenants track by $index"
                                                        ng-click="getTenantID(t)">
                                                        {{t.trade_name}}<br>
                                                    </a>
                                                </div>
                                                <div class="search-results" ng-repeat="t in tenants"
                                                ...
                                                <div class="validation-Error">
                                                    <span
                                                        ng-show="add_form.last_name.$dirty && add_form.last_name.$error.required">
                                                        <p class="error-display">This field is required.</p>
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="last_name" class="col-md-3 control-label"><span
                                                    class="important">*</span>Tenant ID</label>
                                            <div class="col-sm-12 col-md-9 col-lg-9">
                                                <input type="text" class="form-control" id="tenant_id" name="tenant_id"
                                                    ng-model="tenant_id" placeholder="Tenant ID" autocomplete="off"
                                                    required readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <button type="submit" class="btn btn-block btn-primary rounded-6"
                                                    ng-disabled="uploadpertenantform.$invalid"><i
                                                        class="fas fa-upload"></i> Upload Invoice Data</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
