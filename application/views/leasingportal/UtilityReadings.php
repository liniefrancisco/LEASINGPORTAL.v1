...
<div class="content-wrapper" ng-controller="readingscontroller" ng-cloak>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text"><i class="fas fa-tachometer-alt"></i> <strong>Utility Readings</strong></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body">
                            <form ng-submit="getutilityreadings($event)" name="getutilityreadingsform" method="post"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <button type="submit" class="btn btn-block btn-primary rounded-6"
                                                    ng-disabled="getutilityreadingsform.$invalid"><i
                                                        class="fas fa-cogs"></i> Generate Readings</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3" ng-if="readingstable" ng-cloak>
                                <div class="col-12">
                                    <table id="utilityReadings"
                                        class="table table-striped table-bordered table-hover responsive nowrap table-sm display">
                                        <thead class="color">
                                            <tr>
                                                <th class="text-center">Invoice. No</th>
                                                <th class="text-center">Posting Date</th>
