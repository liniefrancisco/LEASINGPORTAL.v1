        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body">
                            <form method="post" id="paymentuploadtableform" ng-cloak
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <label for="inputEmail3" class="col-sm-3 col-form-label"></label>
                                            <div class="col-sm-9">
                                                <button type="submit" class="btn btn-block btn-primary rounded-6"><i
                                                        class="fas fa-cogs"></i> Upload Payment Data</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
