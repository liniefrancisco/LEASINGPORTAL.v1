...
<div class="content-wrapper" ng-controller="soacontroller" ng-cloak>
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text"><i class="fas fa-receipt"></i> <strong>My SOA</strong></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="tradename">Trade Name:</label>
                                        <input type="text" class="form-control rounded-0 text-center currency"
                                            id="tradename" value="<?php echo $this->session->userdata('trade_name') ?>"
                                            readonly>
                                    </div>
                                    <div class="form-group">
                                        <button
                                            class="btn btn-primary btn-block float-right rounded-6 col-sm-12 col-lg-2"
                                            ng-click="gettenantsoa()">GENERATE SOAs</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3" ng-if="soaTable" style="overflow-x:auto;" ng-cloak>
