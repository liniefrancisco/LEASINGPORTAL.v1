            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="card rounded-0">
                        ...
                        <form action="" ng-submit="savenewpassword($event)" method="post" name="changepasswordform"
                            id="changepasswordform" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="newpassword">New Password</label>
                                    <input type="password" class="form-control rounded-0" name="newpassword"
                                        ng-model="newpassword" autocomplete="off" required
                                        ng-pattern="/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{5,}$/" ng-minlength="5">

                                    <div class="validation-Error">
                                        <span
                                            ng-show="changepasswordform.newpassword.$dirty && changepasswordform.newpassword.$error.required">
                                            <p class="error-display">This field is required.</p>
                                        </span>
                                        <span
                                            ng-show="changepasswordform.newpassword.$dirty && changepasswordform.newpassword.$error.pattern">
                                            <p class="error-display">A combination of alphanumeric characters and at
                                                least 1 upppercase.</p>
                                        </span>
                                        <span
                                            ng-show="changepasswordform.newpassword.$dirty && changepasswordform.newpassword.$error.minlength">
                                            <p class="error-display">Atleast 5 characters.</p>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control rounded-0" name="confirmpassword"
                                        ng-pattern="newpassword" ng-model="confirmpassword" autocomplete="off" required>
                                    <div class="validation-Error">
                                        <span
                                        ...
                                        <span
                                            ng-show="changepasswordform.confirmpassword.$dirty && changepasswordform.confirmpassword.$error.pattern">
                                            <p class="error-display">Password not match.</p>
                                        </span>
                                    </div>
                                </div>
