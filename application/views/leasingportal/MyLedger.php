        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body">
                            <form ng-submit="getledger($event)" name="getledgerform" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group row">
                                            <label for="tradename" class="col-sm-3 col-form-label">Trade Name</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control rounded-0" id="tradename"
                                                    name="tradename"
                                        ...
                                        <div class="form-group row">
                                            <label for="tenantid" class="col-sm-3 col-form-label">Tenant ID</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control rounded-0" id="tenantid"
                                                    name="tenantid"
                                                    value="<?php echo $this->session->userdata('tenant_id'); ?>"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" id="datefrom" name="datefrom"
                                                class="form-control rounded-0" ng-model="datefrom" required>
                                        </div>
                                        <div class="input-group mb-3">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <button type="submit" class="btn btn-block btn-primary rounded-6"
                                                    ng-disabled="getledgerform.$invalid"><i class="fas fa-cogs"></i>
                            ...
                            <div ng-if="ledgerTable" ng-cloak>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group row">
                                            <label for="forwardedbalance" class="col-sm-3 col-form-label">Forwarded
                                                Balance</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control text-right rounded-0 currency"
                                                    name="forwardedbalance" ng-value="forwardedbalance | currency : ''"
                                                    value="0.00" readonly>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-3" style="overflow-x:auto;">
                                    <div class="col-sm-12">
                                        <table id="myLedgerTable"
                                            class="table table-striped table-bordered table-hover nowrap table-sm display">
                                            <thead class="color">
                                                <tr>
                                                    <th class="text-center">Type</th>
                                                    <th class="text-center">Doc No.</th>
                                            ...
                                            <tbody>
                                                <tr ng-repeat="l in ledger">
                                                    ...
                                                    <td class="text-right">{{ l.runningBalance | currency : '' }}</td>
                                                    <td class="text-center">
                                                        <button class="btn btn-info btn-xs rounded-6"
                                                            title="Payment Details" data-toggle="modal"
                                                            data-target="#paymentdetailsmodal"
                                                            ng-click="paymentdetails(l)"> Payment Details</button>
                                                    </td>
                                                </tr>
    ...
    <div class="modal fade" id="paymentdetailsmodal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-flat rounded-6" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>
