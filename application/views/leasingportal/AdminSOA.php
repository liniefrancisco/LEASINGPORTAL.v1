                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="from" class="col-sm-3 col-form-label"><span
                                                class="important">*</span> From</label>
                                        <div class="col-sm-12 col-md-9 col-lg-9">
                                            <select class="form-control rounded-0" name="from" ng-model="from" required>
                                                <option value="" disabled="" selected="" style="display:none">Please
                                                    Select One</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <button type="submit" class="btn btn-block btn-primary rounded-6"
                                                ng-click="getsoa()"><i class="fas fa-cogs"></i> Generate SOA
                                                Data</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form method="post" id="soauploadtableform" ng-show="soaupload" ng-cloak
                                ng-submit="uploadsoaselected($event)">
                                <hr>
                                <!-- <div class="row">
                                        ...
                                        <table id="soauploadtable" class="table table-sm table-bordered table-hover">
                                            <thead class="color">
                                                <tr>
                                                    ...
                                                    <th class="text-center" style="position: '' !important;">Trade Name
                                                    </th>
                                                    <th class="text-center">Tenant ID</th>
                                                    <th class="text-center">File Name</th>
                                                    <th class="text-center">Due Date</th>
                                            ...
                                            <tbody style="font-size: 12px;">
                                                <tr ng-repeat="s in soa">
                                                    <td class="text-center">
                                                        <input class="checkbox" type="checkbox" id="soacheck"
                                                            name="soacheck[]" value="{{s.id}}" ng-model="s.soacheck">
                                                    </td>
                                                    <td class="text-center">{{ s.trade_name }}</td>
                                                    <td class="text-center">{{ s.tenant_id }}</td>
                                                    <td class="text-center">{{ s.file_name }}</td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right rounded-0"
                                                                ...
                                                                <a href="#" class="dropdown-item "
                                                                    ng-click="viewsoa(s)"><i class="fas fa-search"></i>
                                                                    View</a>
                                                                <a href="#" class="dropdown-item"
                                                                    ng-click="uploadsoa(s)"><i
