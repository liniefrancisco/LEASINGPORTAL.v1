<div class="content-wrapper" ng-controller="adminsoa" ng-cloak>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-book"></i><strong>Upload SOA Data</strong></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card rounded-0">
                        <div class="card-body">
                            ...
                            <form method="post" id="soauploadtableform" ng-show="soaupload" ng-cloak ng-submit="uploadsoaselected($event)"><hr>
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group row">
                                            <label for="forwardedbalance" class="col-form-label"></label>
                                            <div class="col-sm-5">
                                                <button type="submit" class="btn btn-info btn-sm btn-flat" title="Upload Selected" name="uploadselect" ng-disabled="uploadselect"><i class="fas fa-upload"></i> Upload Selected</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table id="soauploadtable" class="table table-sm table-bordered table-hover">
                                            ...
                                            <tbody style="font-size: 12px;">
                                                <tr ng-repeat="s in soa">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            <button class="btn btn-info dropdown-toggle btn-sm btn-flat" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Action</button>
            ...
            <div class="modal-body">
                <div class="col-sm-12 col-lg-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control rounded-0" id="tenantid" name="tenantid" ng-model="invoiceno" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="tenantid" class="col-sm-3 col-form-label">Posting Date</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control rounded-0" id="tenantid" name="tenantid" ng-model="postingdate" readonly>
                        </div>
                    </div>
                </div>
