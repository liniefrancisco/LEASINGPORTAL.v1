            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                    <div class="card rounded-0">
                        ...
                        <form action="" ng-submit="savenewusername($event)" method="post" name="changeuserform"
                            id="changeuserform" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="newusername">New Username</label>
                                    <input type="text" class="form-control rounded-0" name="newusername"
                                        ng-model="newusername" autocomplete="off" required ng-minlength="5">

                                    <div class="validation-Error">
                                        <span
                                            ng-show="changeuserform.newusername.$dirty && changeuserform.newusername.$error.required">
                                            <p class="error-display">This field is required.</p>
                                        </span>
                                        <span
                                            ng-show="changeuserform.newusername.$dirty && changeuserform.newusername.$error.minlength">
                                            <p class="error-display">Atleast 5 characters.</p>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-info float-right rounded-6"
                                        ng-disabled="changeuserform.$invalid">
                                        <i class="fas fa-paper-plane"></i> Save Changes
                                    </button>
                                </div>
                                <!-- /.card-footer -->
